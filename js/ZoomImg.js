            ...
            i = function () {
                ...
                return new n(function (e) {
                    if (d && -1 === m.indexOf(d)) e(f);
                        ...
                        function t() {
                            (c = !1),
                                s.zoomed.removeEventListener(
                                    "transitionend",
                                    t
                                ),
                                s.original.dispatchEvent(
                                    E("medium-zoom:opened", {
                                        detail: { zoom: f },
                                    })
                                ),
                                e(f);
                        ...
                        if (s.zoomed) e(f);
                            ...
                            s.original.dispatchEvent(
                                ...
                                s.original.classList.add(
                                    "medium-zoom-image--hidden"
                                ),
                                s.zoomed.classList.add(
                                ...
                                s.original.getAttribute("data-zoom-src")
                                    ? ((s.zoomedHd = s.zoomed.cloneNode()),
                                      ...
                                      (o = setInterval(function () {
                                          s.zoomedHd.complete &&
                                              (clearInterval(o),
                                              s.zoomedHd.classList.add(
                                                  "medium-zoom-image--opened"
                                              ),
                                              s.zoomedHd.addEventListener(
                                                  "click",
                                                  a
                                              ),
                                    ...
                                    ? ((s.zoomedHd = s.zoomed.cloneNode()),
                                      s.zoomedHd.removeAttribute("sizes"),
                                      s.zoomedHd.removeAttribute("loading"),
                                      (n = s.zoomedHd.addEventListener(
                                          "load",
                                          function () {
                                              s.zoomedHd.removeEventListener(
                                                  "load",
                                                  n
                                              ),
                                                  s.zoomedHd.classList.add(
                    ...
                    !c && s.original
                        ? ((e = function e() {
                              s.original.classList.remove(
                                  ...
                                  s.zoomedHd &&
                                      document.body.removeChild(s.zoomedHd),
                                  document.body.removeChild(p),
                                  s.zoomed.classList.remove(
                                      "medium-zoom-image--opened"
                                  ),
                                  s.template &&
                                      document.body.removeChild(s.template),
                                  (c = !1),
                                  s.zoomed.removeEventListener(
                                      "transitionend",
                                      e
            ...
            update: function () {
                ...
                return (
                    ...
                    m.forEach(function (e) {
                        e.dispatchEvent(
                            E("medium-zoom:update", { detail: { zoom: f } })
                        );
                    }),
                    f
                );
                ...
                return (
                    i.forEach(function (e) {
                        e.classList.remove("medium-zoom-image"),
                            e.dispatchEvent(
                                E("medium-zoom:detach", { detail: { zoom: f } })
                            );
                    }),
