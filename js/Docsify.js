!(function () {
    ...
    (I.prototype.getBasePath = function () {
        ...
        (I.prototype.toURL = function (e, n, i) {
            ...
            if (
                ...
                o &&
                    (e =
                        (0 < (o = i.indexOf("?")) ? i.substring(0, o) : i) + e),
        ...
        D = (function (n) {
            ...
            return (
                ...
                (((e.prototype = Object.create(n && n.prototype)).constructor =
                    ...
                    return (
                        ((n =
                            e && 0 === n.indexOf(e) ? n.slice(e.length) : n) ||
                            "/") +
            ...
            !n ||
                ((r = fe[ve(e, n.getAttribute("data-id"))]) &&
                    ...
                    !pe &&
                        ...
                        (a =
                            a.offsetTop >= t.scrollTop && r <= t.scrollTop + e),
            ...
            return (
                ...
                (e.prototype.em = function (e, n, i) {
                    ...
                    if (
                        ...
                        for (a.lastIndex = 0; null != (o = a.exec(n)); )
                            if (
                                (t = this.rules.inline.em.middle.exec(
                                    n.slice(0, o.index + 2)
                                ))
                            )
                                return {
                ...
                (e.prototype.url = function (e, n) {
                    ...
                    if ((i = this.rules.inline.url.exec(e))) {
                        if ("@" === i[2])
                            t =
                                "mailto:" +
                                (o = Je(this.options.mangle ? n(i[0]) : i[0]));
                        else {
                            for (
                                ;
                                (a = i[0]),
                                    (i[0] = this.rules.inline._backpedal.exec(
                                        i[0]
                                    )[0]),
                                    a !== i[0];
                    ...
                    for (
                        ...
                        if ((o = this.tokenizer.space(e)))
                            ...
                            for (
                                ...
                                o.items[t].tokens = this.blockTokens(
                                    o.items[t].text,
                                    [],
                                    !1
                                );
                ...
                (i.prototype.inlineTokens = function (e, n, i, o) {
                    ...
                    for (; e; )
                        if (
                            ...
                            (t = this.tokenizer.reflink(e, this.tokens.links))
                        )
                            (e = e.substring(t.raw.length)),
                                "link" === t.type &&
                                    (t.tokens = this.inlineTokens(
        ...
        sn = (function () {
            ...
            return (
                ...
                (e.prototype.link = function (e, n, i) {
                    if (
                        null ===
                        (e = dn(this.options.sanitize, this.options.baseUrl, e))
                    )
                        return i;
                    e = '<a href="' + gn(e) + '"';
                    return (
                            ...
                            case "table":
                                ...
                                for (
                                    ...
                                    for (
                                        ...
                                        c += this.renderer.tablecell(
                                            this.parseInline(r[o]),
                                            { header: !1, align: f.align[o] }
                                        );
    ...
    function xn(e, i, o) {
        ...
        try {
            var n = fn.lex(e, i);
            return (
                i.walkTokens && xn.walkTokens(n, i.walkTokens), mn.parse(n, i)
            );
        } catch (e) {
            if (
                ((e.message +=
    ...
    function zn(e, o) {
        ...
        return (
            e.forEach(function (e) {
                ...
                o < n ||
                    (a[i]
                        ? (a[i].children = (a[i].children || []).concat(e))
                        : t.push(e),
                    (a[n] = e));
            }),
            t
    ...
    var Cn = {
        ...
        data: {
            ...
            family_man_woman_girl_girl:
                "unicode/1f468-1f469-1f467-1f467.png?v8",
            ...
            family_woman_woman_boy_boy:
                "unicode/1f469-1f469-1f466-1f466.png?v8",
            family_woman_woman_girl: "unicode/1f469-1f469-1f467.png?v8",
            family_woman_woman_girl_boy:
                "unicode/1f469-1f469-1f467-1f466.png?v8",
            family_woman_woman_girl_girl:
                "unicode/1f469-1f469-1f467-1f467.png?v8",
            ...
            scotland:
                "unicode/1f3f4-e0067-e0062-e0073-e0063-e0074-e007f.png?v8",
                ...
                void 0 !== g &&
                    ...
                    (n = !(g.plugins.fileHighlight = {
                        highlight: function (e) {
                            for (
                                var n,
                                    i = (e || document).querySelectorAll(d),
                                    o = 0;
                                (n = i[o++]);
                    ...
                    (g.fileHighlight = function () {
                        n ||
                            ...
                            (n = !0)),
                            g.plugins.fileHighlight.highlight.apply(
                                this,
                                arguments
                            );
                    }));
    ...
    function In(t, e) {
        ...
        (this.config = t),
            ...
            (this.linkRel =
                "_blank" === this.linkTarget
                    ? t.externalLinkRel || "noopener"
                    : ""),
    ...
    (In.prototype.compileEmbed = function (e, n) {
        ...
        (In.prototype._matchNotCompileLink = function (e) {
            for (
                var n = this.config.noCompileLinks || [], i = 0;
                i < n.length;
                i++
            ) {
                var o = n[i];
        ...
        (In.prototype._initRenderer = function () {
            ...
            return (
                    ...
                    function (e, n) {
                        ...
                        /<!-- {docsify-ignore} -->/g.test(o) &&
                            ...
                            /{docsify-ignore-all}/g.test(o) &&
                                ...
                                (e.ignoreAllSubs = !0));
                        (i = Tn(t.id || o)),
                            (t = a.toURL(a.getCurrentPath(), { id: i }));
                        return (
                            (e.slug = t),
                            g.toc.push(e),
                            "<h" +
                ...
                (t.link =
                    ...
                    (i.link = function (e, n, i) {
                        ...
                        return (
                            ...
                            (r =
                                "_blank" === u
                                    ? f.config.externalLinkRel || "noopener"
                                    : ""),
                            (n = a),
                ...
                (t.image =
                    ((o = (i = { renderer: e, contentBase: o, router: a })
                        .renderer),
                    (p = i.contentBase),
                    (d = i.router),
                        ...
                        e &&
                            ("markdown" === t.embed.type
                                ? ((i = t.embed.url.split("/")).pop(),
                                  ...
                                  !0 ===
                                      (($docsify.frontMatter || {}).installed ||
                                          !1) &&
                                      (e =
                                          $docsify.frontMatter.parseMarkdown(
                                              e
                                          )),
                                  (n = r.lexer(e)))
                                : "code" === t.embed.type
    ...
    function Wn(n, i, o, t, a, e) {
        (n = e ? n : n.replace(/\/$/, "")),
            (n = C(n)) &&
                X(
                    a.router.getFile(n + o) + i,
                    !1,
                    a.config.requestHeaders
                ).then(t, function (e) {
                    return Wn(n, i, o, t, a);
                });
    }
            ...
            (function (e) {
                ...
                return (
                    ...
                    (((n.prototype = Object.create(
                        e && e.prototype
                    )).constructor = n).prototype._loadSideAndNav = function (
                        e,
                        n,
                        i,
                        o
                            ...
                            : ((t = E(f, ["id"])),
                              ...
                              (c = function (e, n) {
                                  o._renderMain(
                                      e,
                                      n,
                                      o._loadSideAndNav(p, t, a, i)
                                  );
                              }),
                              (u = function (e) {
                                  o._fetchFallbackPage(p, t, i) ||
                                      o._fetch404(r, t, i);
                              }),
                              this.isRemoteUrl
                                  ? Kn(r + t, 0, n).then(c, u)
                                  : this.matchVirtualRoute(p).then(function (
                                        e
                                    ) {
                                        "string" == typeof e
                                            ? c(e)
                    ...
                    (n.prototype._fetchFallbackPage = function (i, o, t) {
                        ...
                        e = this.router.getFile(
                            i.replace(new RegExp("^/" + e), "")
                        );
                        return (
                            Kn(e + o, 0, n).then(
                                function (e, n) {
                                    return a._renderMain(
                                        e,
                                        n,
                                        a._loadSideAndNav(i, o, c, t)
                                    );
                                },
                                function () {
                ...
                (function (e) {
                    ...
                    return (
                        ...
                        (((n.prototype = Object.create(
                            e && e.prototype
                        )).constructor = n).prototype.$resetEvents = function (
                            e
                        ) {
                            var n = this,
                            ...
                            "history" !== e &&
                                (n.route.query.id &&
                                    he(n.route.path, n.route.query.id),
                                "navigate" === e &&
                                    i &&
                                    ((i = i),
                                    (_e.scrollTop =
                                ...
                                null != (e = l(e)) &&
                                    p(e, "click", function (e) {
                                        ...
                                        "A" === e.nodeName &&
                                            ...
                                            e.nextSibling.classList.contains(
                                                "app-sub-sidebar"
                                            ) &&
                    ...
                    (function (e) {
                        ...
                        return (
                            ...
                            (((n.prototype = Object.create(
                                e && e.prototype
                            )).constructor = n).prototype._renderTo = function (
                                e,
                                n,
                                i
                            ) {
                            ...
                            (n.prototype._renderCover = function (e, n) {
                                ...
                                S(l("main"), n ? "add" : "remove", "hidden"),
                                    e
                                        ? (S(o, "add", "show"),
                                          (n = (i = this.coverIsHTML
                                              ? e
                                              : this.compiler.cover(e))
                                              .trim()
                                              .match(
                            ...
                            (n.prototype.initRender = function () {
                                ...
                                (this.compiler = new In(e, this.router)),
                                    (window.__current_docsify_compiler__ =
                                        this.compiler);
                                var n,
                                    i,
                                    o,
                        ...
                        (function (e) {
                            ...
                            return (
                                ...
                                (((n.prototype = Object.create(
                                    e && e.prototype
                                )).constructor = n).prototype.routes =
                                    function () {
                            ...
                            (function (i) {
                                ...
                                return (
                                    ...
                                    (((e.prototype = Object.create(
                                        i && i.prototype
                                    )).constructor = e).prototype.updateRender =
                                        function () {
                                            this.router.normalize(),
                                                (this.route =
                                                    this.router.parse()),
