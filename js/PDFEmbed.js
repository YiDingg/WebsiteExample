...
!(function () {
    ...
    var doc_md_rend = (doc_md.renderer =
    ...
    window.$docsify.plugins = [
        function (hook, vm) {
            hook.init(function () {
                ...
                verbose_log(
                    "This is a "
                        .concat(mobile_view ? "Mobile" : "Non-mobile")
                        .concat(" Viewer.")
                );
            });
            hook.afterEach(function (html, next) {
                verbose_log(
                    "PDF Code Block Loader Plugin After Hook Initialized"
                );
                container_list = JSON.parse(
                    localStorage.getItem("pdf_container_list")
                );
                ...
                if (container_list) {
                    ...
                    if (mobile_view) {
                        ...
                        container_list.forEach(function (container) {
                            var absolute_pdf_location = url_check(
                            ...
                            var view_location =
                                ...
                                absolute_pdf_location;
                            var iframe_id =
                                container["div_id"].concat("-iframe");
                            html +=
                                '\
